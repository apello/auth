...
} elseif(!empty($_POST['newbday']) && !empty($_POST['id'])){

	
	$sql = "UPDATE patient SET dob = '$newbday' WHERE id = '$id'";
...
<div class="subjectBox">Edit Birth Date:</div>

<form action="editbday.php" method="post">

<input type="number" name="id" class="inputBox" placeholder="Enter patient's ID here:">
<div class="titleBox">Enter new date of birth:</div>
<input type="date" name="newbday" class="inputBox">
