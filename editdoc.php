...
} elseif(!empty($_POST['newdoc']) && !empty($_POST['id'])){

	
	$sql = "UPDATE patient SET doc = '$newdoc' WHERE id = '$id'";
...
<div class="subjectBox">Edit Doctor:</div>

<form action="editdoc.php" method="post">

<input type="number" name="id" class="inputBox" placeholder="Enter patient's ID here:">
<input type="text" name="newdoc" class="inputBox" placeholder="Enter new doctor here:">
